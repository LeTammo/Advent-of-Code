...
so in order to save Christmas, you need to help them get _**fifty stars**_ on their list 
...
in the left list after multiplying it by the number of times that number appears 
in the right list.
